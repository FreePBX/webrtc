...
function createSipStack(){
    sipStack = new SIPml.Stack({
            ...
            impi: '1020', // mandatory: authorization name (IMS Private Identity)
            impu: 'sip:1020@199.102.239.103', // mandatory: valid SIP Uri (IMS Public Identity)
            password: '41601e115c62b552d3afbbe859b911c9', // optional
